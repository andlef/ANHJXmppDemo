...
//        image = [[UIImage alloc] initWithContentsOfFile:path];
        UIImageView * tmpView = (UIImageView*)mediaView;
        NSData * tmpData = UIImageJPEGRepresentation(tmpView.image, 1.0);
        image = [[UIImage alloc] initWithData:tmpData];
...
- (void)installZoomView
{
    ...
    scrollView = [[ASImageScrollView alloc] initWithFrame:CGRectMake(0, 0, 320, 480)];
